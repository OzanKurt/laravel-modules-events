...
use Kurt\Modules\Events\Filament\V3\Resources\EventResource;
...
use Kurt\Modules\Events\Filament\V3\Resources\WaitlistResource;
...
it('dispatches the facade to the v3 plugin', function () {
    expect(EventsPlugin::make())->toBeInstanceOf(Kurt\Modules\Events\Filament\V3\EventsPlugin::class)
